...
export class MainItemComponent implements OnInit{
    ...
    maingirl: main[] | null = null;
    trackByy(index: number, Demo: main){
      return Demo ? Demo.id : undefined;
    }
  ...
  constructor(config: NgbCarouselConfig) {
    ...
    this.maingirl = [
      new maingirl(1,"Áo Polo Thể Thao Nữ Phối Màu ","195.000","-50%","/assets/storage/image/aonu1.webp","/assets/storage/image/ao_nu1.webp","Đã bán 141k"),
      new maingirl(2,"Áo Polo Thể Thao Nữ Phối Màu  ","195.000","-30%","/assets/storage/image/aonu2.webp","/assets/storage/image/ao_nu1.webp","Đã bán 120k"),
      new maingirl(3,"Áo Polo Thể Thao Nữ Phối Màu  ","300.000","-10%","/assets/storage/image/aonu3.webp","/assets/storage/image/ao_nu1.webp","Đã bán 100k"),
      new maingirl(4,"Áo Polo Thể Thao Nữ Phối Màu  ","195.000","-80%","/assets/storage/image/aonu4.webp","/assets/storage/image/ao_nu1.webp","Đã bán 123k"),
      new maingirl(5,"Áo Polo Thể Thao Nữ Phối Màu  ","195.000","-40%","/assets/storage/image/aonu5.webp","/assets/storage/image/ao_nu1.webp","Đã bán 101k")
    ];  
  }
  ngOnInit(): void {  
  }
